...
import { Pool } from 'pg';
import { chartOfAccounts, organizations } from '../src/schema';
...
// ─── شجرة الحسابات الكاملة (بالترتيب: الآباء قبل الأبناء) ───────────────────
const accounts: AccountSeed[] = [
  ...
  { code:'52',     name:'تكلفة المبيعات',                  type:'expenses',    nature:'debit',  level:2, parentCode:'5',    isParent:true,  allowPosting:false },
  { code:'53',     name:'المصروفات الإدارية والعمومية',   type:'expenses',    nature:'debit',  level:2, parentCode:'5',    isParent:true,  allowPosting:false },
  { code:'54',     name:'المصروفات البيعية والتسويقية',   type:'expenses',    nature:'debit',  level:2, parentCode:'5',    isParent:true,  allowPosting:false },
  { code:'55',     name:'المصروفات التشغيلية',             type:'expenses',    nature:'debit',  level:2, parentCode:'5',    isParent:true,  allowPosting:false },
  { code:'56',     name:'الإهلاك',                          type:'expenses',    nature:'debit',  level:2, parentCode:'5',    isParent:true,  allowPosting:false },
  { code:'57',     name:'مصروفات أخرى',                    type:'expenses',    nature:'debit',  level:2, parentCode:'5',    isParent:true,  allowPosting:false },
  ...
  { code:'510201', name:'مردودات فرع 1',                  type:'expenses',    nature:'credit', level:4, parentCode:'5102', isParent:false, allowPosting:true  },
  { code:'510202', name:'مردودات فرع 2',                  type:'expenses',    nature:'credit', level:4, parentCode:'5102', isParent:false, allowPosting:true  },
  { code:'510203', name:'مردودات فرع 3',                  type:'expenses',    nature:'credit', level:4, parentCode:'5102', isParent:false, allowPosting:true  },

  { code:'510301', name:'خصم مكتسب فرع 1',               type:'expenses',    nature:'credit', level:4, parentCode:'5103', isParent:false, allowPosting:true  },
  { code:'510302', name:'خصم مكتسب فرع 2',               type:'expenses',    nature:'credit', level:4, parentCode:'5103', isParent:false, allowPosting:true  },
  { code:'510303', name:'خصم مكتسب فرع 3',               type:'expenses',    nature:'credit', level:4, parentCode:'5103', isParent:false, allowPosting:true  },

  // 52 (أوراق نهائية)
  { code:'5201',   name:'تكلفة مبيعات فرع 1',            type:'expenses',    nature:'debit',  level:3, parentCode:'52',   isParent:false, allowPosting:true  },
  { code:'5202',   name:'تكلفة مبيعات فرع 2',            type:'expenses',    nature:'debit',  level:3, parentCode:'52',   isParent:false, allowPosting:true  },
  { code:'5203',   name:'تكلفة مبيعات فرع 3',            type:'expenses',    nature:'debit',  level:3, parentCode:'52',   isParent:false, allowPosting:true  },
  { code:'5204',   name:'تكلفة تشغيل أخرى',              type:'expenses',    nature:'debit',  level:3, parentCode:'52',   isParent:false, allowPosting:true  },

  // 53 ─ المصروفات الإدارية والعمومية (أوراق نهائية)
  { code:'5301',   name:'الرواتب والأجور',                type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },
  { code:'5302',   name:'بدلات وسكن',                     type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },
  { code:'5303',   name:'كهرباء ومياه',                   type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },
  { code:'5304',   name:'اتصالات وإنترنت',                type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },
  { code:'5305',   name:'إيجارات',                         type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },
  { code:'5306',   name:'رسوم حكومية',                    type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },
  { code:'5307',   name:'تأمينات',                         type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },
  { code:'5308',   name:'صيانة',                           type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },
  { code:'5309',   name:'أدوات مكتبية',                   type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },
  { code:'5310',   name:'ضيافة وبوفيه',                   type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },
  { code:'5311',   name:'برامج وأنظمة',                   type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },
  { code:'5312',   name:'عمولات بنكية',                   type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },
  { code:'5313',   name:'سفر وانتقالات',                  type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },
  { code:'5314',   name:'مصروفات قانونية',                type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },
  { code:'5315',   name:'مصروفات بريد وشحن',              type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },
  { code:'5316',   name:'مصروفات متنوعة',                 type:'expenses',    nature:'debit',  level:3, parentCode:'53',   isParent:false, allowPosting:true  },

  // 54 ─ المصروفات البيعية والتسويقية (أوراق نهائية)
  { code:'5401',   name:'رواتب المبيعات',                 type:'expenses',    nature:'debit',  level:3, parentCode:'54',   isParent:false, allowPosting:true  },
  { code:'5402',   name:'عمولات البيع',                   type:'expenses',    nature:'debit',  level:3, parentCode:'54',   isParent:false, allowPosting:true  },
  { code:'5403',   name:'دعاية وإعلان',                   type:'expenses',    nature:'debit',  level:3, parentCode:'54',   isParent:false, allowPosting:true  },
  { code:'5404',   name:'نقل وتحميل',                     type:'expenses',    nature:'debit',  level:3, parentCode:'54',   isParent:false, allowPosting:true  },
  { code:'5405',   name:'وقود ومحروقات',                  type:'expenses',    nature:'debit',  level:3, parentCode:'54',   isParent:false, allowPosting:true  },
  { code:'5406',   name:'صيانة السيارات',                 type:'expenses',    nature:'debit',  level:3, parentCode:'54',   isParent:false, allowPosting:true  },
  { code:'5407',   name:'هدايا وعينات',                   type:'expenses',    nature:'debit',  level:3, parentCode:'54',   isParent:false, allowPosting:true  },
  { code:'5408',   name:'إيجارات المعارض',                type:'expenses',    nature:'debit',  level:3, parentCode:'54',   isParent:false, allowPosting:true  },
  { code:'5409',   name:'شحن وتوصيل',                     type:'expenses',    nature:'debit',  level:3, parentCode:'54',   isParent:false, allowPosting:true  },
  { code:'5410',   name:'مصروفات تسويق أخرى',            type:'expenses',    nature:'debit',  level:3, parentCode:'54',   isParent:false, allowPosting:true  },

  // 55 ─ المصروفات التشغيلية (أوراق نهائية)
  { code:'5501',   name:'مصروف أجور ورواتب',             type:'expenses',    nature:'debit',  level:3, parentCode:'55',   isParent:false, allowPosting:true  },
  { code:'5502',   name:'وقود وتشغيل',                    type:'expenses',    nature:'debit',  level:3, parentCode:'55',   isParent:false, allowPosting:true  },
  { code:'5503',   name:'صيانة وتشغيل',                   type:'expenses',    nature:'debit',  level:3, parentCode:'55',   isParent:false, allowPosting:true  },
  { code:'5504',   name:'أدوات تشغيل',                    type:'expenses',    nature:'debit',  level:3, parentCode:'55',   isParent:false, allowPosting:true  },
  { code:'5505',   name:'كهرباء التشغيل',                 type:'expenses',    nature:'debit',  level:3, parentCode:'55',   isParent:false, allowPosting:true  },
  { code:'5506',   name:'مصروفات تشغيل أخرى',            type:'expenses',    nature:'debit',  level:3, parentCode:'55',   isParent:false, allowPosting:true  },

  // 56 ─ الإهلاك (أوراق نهائية)
  { code:'5601',   name:'إهلاك المباني',                   type:'expenses',    nature:'debit',  level:3, parentCode:'56',   isParent:false, allowPosting:true  },
  { code:'5602',   name:'إهلاك السيارات',                  type:'expenses',    nature:'debit',  level:3, parentCode:'56',   isParent:false, allowPosting:true  },
  { code:'5603',   name:'إهلاك المعدات',                   type:'expenses',    nature:'debit',  level:3, parentCode:'56',   isParent:false, allowPosting:true  },
  { code:'5604',   name:'إهلاك الحاسب الآلي',              type:'expenses',    nature:'debit',  level:3, parentCode:'56',   isParent:false, allowPosting:true  },
  { code:'5605',   name:'إهلاك الأثاث',                    type:'expenses',    nature:'debit',  level:3, parentCode:'56',   isParent:false, allowPosting:true  },
  { code:'5606',   name:'إهلاك الرافعات',                  type:'expenses',    nature:'debit',  level:3, parentCode:'56',   isParent:false, allowPosting:true  },

  // 57 ─ مصروفات أخرى (أوراق نهائية)
  { code:'5701',   name:'خسائر فروقات عملة',              type:'expenses',    nature:'debit',  level:3, parentCode:'57',   isParent:false, allowPosting:true  },
  { code:'5702',   name:'غرامات ومخالفات',                type:'expenses',    nature:'debit',  level:3, parentCode:'57',   isParent:false, allowPosting:true  },
  { code:'5703',   name:'ديون معدومة',                     type:'expenses',    nature:'debit',  level:3, parentCode:'57',   isParent:false, allowPosting:true  },
  { code:'5704',   name:'زكاة وضريبة',                    type:'expenses',    nature:'debit',  level:3, parentCode:'57',   isParent:false, allowPosting:true  },
  { code:'5705',   name:'تبرعات وصدقات',                  type:'expenses',    nature:'debit',  level:3, parentCode:'57',   isParent:false, allowPosting:true  },
];
...
async function seed() {
  ...
  console.log(`المنظمات الموجودة: ${orgs.map(o => `${o.id} (${o.name})`).join(', ')}`);

  for (const org of orgs) {
    console.log(`\n═══ بدء seeding للمنظمة: ${org.name} (id=${org.id}) ═══`);

    // حذف الحسابات الموجودة لهذه المنظمة
    await db.delete(chartOfAccounts).where(eq(chartOfAccounts.orgId, org.id));
    console.log(`  ✓ تم حذف الحسابات القديمة`);

    // خريطة code → id للمراجع
    ...
    for (const acc of accounts) {
      ...
      if (parentId !== undefined) insertData.parentId = parentId;

      const [row] = await db.insert(chartOfAccounts).values(insertData as any).returning({ id: chartOfAccounts.id });
      codeToId.set(acc.code, row.id);
      inserted++;
    }

    console.log(`  ✓ تم إدراج ${inserted} حساب بنجاح`);
  }

  console.log('\n✅ اكتمل seeding شجرة الحسابات لجميع المنظمات');
  await pool.end();
}

seed().catch(e => { console.error('❌ خطأ:', e.message); pool.end(); process.exit(1); });
