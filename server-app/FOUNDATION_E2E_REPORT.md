...
Timestamp : 2026-07-16T04:49:00.392Z
...
════════════════════════════════════════════════════════════
  【4/10】 تثبيت جديد — تطبيق القالب الكامل (مسار الإنتاج)
════════════════════════════════════════════════════════════
...
════════════════════════════════════════════════════════════
  ...
  ✅ branch_id مُعاد الرسم: المصدر id=4 → الوجهة id=1 ✅
  ✅ warehouse_id=1 مُحَل من "wh.المخزن_الرئيسي" ✅
  ✅ warehouse_id مُعاد الرسم: المصدر id=14 → الوجهة id=1 ✅
  ✅ sales_account_id=1 مُحَل من systemKey="cert.sales.account" ✅

  ── إثبات الرفض الصارم للـ FK غير المحلول (لا null صامت):
  ✅ الرفض الصارم: سجل ذو FK وهمي رُفض (error: "document_journals[e2e.strict.fk.test]: فشل حل FK — branchId:...") — لا null صامت ✅
...
════════════════════════════════════════════════════════════
  ...
  ✅ الدفتر flexible (fk=dj.sales_invoice.sls-3) لم يُعَد إدراجه — قرار المستخدم محفوظ ✅

  ── 7d-edit. editable: يُعاد إدراجه إذا حُذف (Foundation Update يصحح):
  ✅ الدفتر editable (fk=dj.sales.inv.02.) أُعيد إدراجه كـ id=20 ✅
...
════════════════════════════════════════════════════════════
  ✅ pg_dump: /tmp/onesoft-backups/e2e_task118_1784177342571.sql (363.8 KB)

  ── فشل متعمَّد: حذف جميع الدفاتر...
  ✅ تم الإفساد: دفاتر TESTCO من 18 → 0 ✅

  ── الاستعادة من النسخة الاحتياطية...
  ✅ الاستعادة نجحت: دفاتر TESTCO = 18 (= 18 قبل الإفساد) ✅
...
╔════════════════════════════════════════════════════════════╗
║  النتيجة: 34 نجاح — ✅ لا فشل
╚════════════════════════════════════════════════════════════╝

```

*تاريخ الاختبار: 2026-07-16T04:49:19.973Z*
