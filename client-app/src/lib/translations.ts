...
const AR = {
  ...
  online: "متصل",
  offline: "غير متصل",
  switchToHorizontal: "تبديل إلى القائمة الأفقية",
  switchToVertical: "تبديل إلى القائمة الرأسية",
  horizontal: "أفقي",
  vertical: "رأسي",
...
const EN: Record<keyof typeof AR, string> = {
  ...
  online: "Online",
  offline: "Offline",
  switchToHorizontal: "Switch to Horizontal Menu",
  switchToVertical: "Switch to Vertical Menu",
