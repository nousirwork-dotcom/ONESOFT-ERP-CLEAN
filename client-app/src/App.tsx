...
import SettingsModule, {
  ...
  CfgDocTypesTab, CfgDocBooksTab, CfgDocumentJournalsTab, CfgPostingDefinitionsTab, CfgDocumentTypesTab, CfgDocumentTemplatesTab,
...
export const PAGE_MAP: Record<string, React.ComponentType<any>> = {
  ...
  "/cfg/posting-definitions":    CfgPostingDefinitionsTab,
